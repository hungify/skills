...
Sections appear after the closing `---` of the frontmatter, in this exact order. Use `##` headings. **All 8 sections are required and must appear in this canonical order:**

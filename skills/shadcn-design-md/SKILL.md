...
description: Read an existing shadcn/Tailwind codebase and produce a DESIGN.md that records its observed visual language for future UI work. Use when the user asks to document an existing project's design system, visual style, or DESIGN.md. Do not use for greenfield token invention; derive every value from project files.
---
...
- "write a DESIGN.md for this existing project"
- "document this codebase's design system"
- "capture the existing visual language / UI style"

Use this skill before implementation only when existing shadcn/Tailwind source is the design evidence.
